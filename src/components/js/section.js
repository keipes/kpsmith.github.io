...
export default class Section extends React.Component {
	...
	render() {
		return (
			React.createElement("div", {style: this.elementStyle}, 
				React.createElement("div", {style: this.backgroundStyle}), 
				React.createElement("div", {style: this.foregroundStyle}, this.props.index)
			)
		);
	}
}